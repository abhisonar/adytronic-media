...
const HeroSection = () => {
  return (
    <div
      className={`bg-hero-pattern  flex flex-col px-3 pt-[150px] h-[100vh] mt-[-100px] lg:pt-[200px]:px-[100px]`}>
      <UiHeaderChip>
        <span className="font-medium">Best Solution we offer you</span>
      </UiHeaderChip>
      <h1 className="text-4xl font-semibold mt-7">Make a good plan & grow your business</h1>
      ...
      <div className="flex mt-5 gap-3">
        <UiButton
          ...
          color="primary"
          size="large"
          className="rounded-lg !px-5 !py-2 !drop-shadow-lg">
