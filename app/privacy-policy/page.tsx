...
const PrivacyPolicy = () => {
  return (
    <div className="privacy pt-5 lg:px-10">
      <h1>Privacy Policy</h1>
      <p>
        Last updated: <strong>February 18, 2024</strong>
      </p>
      <p>
      ...
      <p>
        ...
        collection and use of information by this Privacy Policy.
      </p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot; Us&quot; or &quot; Our&quot; in this Agreement) refers to Adytronic Media,
            Nashik, Maharashtra.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Adytronic Media, accessible from{" "}
            <a href="www.adytronic.com" rel="external nofollow no opener" target="_blank">
              www.adytronic.com
            </a>
          </p>
        </li>
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            Cookies is to provide You with a more personal experience and to avoid having to
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            promotional campaigns and evaluating and improving our Service, products, services,
      ...
      <ul>
        ...
        <li>
          ...
          which case we will require those affiliates to honour this Privacy Policy. Affiliates
      ...
      <p>
        The Company will retain Your Data only for as long as is necessary for the purposes set out
        in this Privacy Policy. We will retain and use Your Data to the extent necessary to comply
        with our legal obligations (for example, if we are required to retain your data to comply
      ...
      <p>
        If the Company is involved in a merger, acquisition or asset sale, Your Data may be
        transferred. We will provide notice before Your Data is transferred and becomes subject to a
        different Privacy Policy.
      </p>
      <h4>Law enforcement</h4>
      <p>
        Under certain circumstances, the Company may be required to disclose Your Data if required
        to do so by law or in response to valid requests by public authorities (e.g. a court or a
        government agency).
      </p>
      <h4>Other legal requirements</h4>
      <p>
        The Company may disclose Your Data in the good faith belief that such action is necessary
        to:
      </p>
      <ul>
      ...
      <p>
        ...
        becomes effective and update the &quot; Last updated&quot; date at the top of this Privacy
        Policy.
      </p>
      <p>
      ...
      <ul>
        <li>
          <p>By email: info@adytronic.com</p>
        </li>
        <li>
          <p>By phone number: +91 82081 48344</p>
        </li>
      </ul>
    </div>
  );
